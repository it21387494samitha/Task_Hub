<x-guest-layout>
    ...
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <div>
            ...
            <x-text-input id="email" class="block mt-1.5 w-full px-4 py-2.5" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" />
        ...
        <div class="mt-5">
            ...
            <x-text-input id="password" class="block mt-1.5 w-full px-4 py-2.5" type="password" name="password" required autocomplete="new-password" placeholder="••••••••" />
        ...
        <div class="mt-5">
            ...
            <x-text-input id="password_confirmation" class="block mt-1.5 w-full px-4 py-2.5" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="••••••••" />
