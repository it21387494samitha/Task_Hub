<x-guest-layout>
    ...
    <div class="text-center mb-8">
        <div class="mx-auto w-12 h-12 rounded-xl bg-amber-500/10 flex items-center justify-center mb-4">
        ...
        <p class="mt-1.5 text-sm text-gray-500">This is a secure area. Please confirm your password to continue.</p>
    </div>
